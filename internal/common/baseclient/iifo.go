...
func (c *BaseClient) MakeForageInfo() shared.ShareForageInfomation {
	contribution := shared.ForageDecision{Type: shared.DeerForageType, Contribution: 0}
	return shared.ShareForageInfomation{DecisionMade: contribution, ResourceObtained: 0, ShareTo: []shared.ClientID{}}
}
...
// OPTIONAL.
func (c *BaseClient) ReceiveForageInfo(neighbourForaging []shared.ShareForageInfomation) {
